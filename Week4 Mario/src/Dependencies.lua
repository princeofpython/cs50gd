...
gTextures = {
    ...
    ['locks-keys'] = love.graphics.newImage('graphics/keys_and_locks.png'),
    ['poles-flags'] = love.graphics.newImage('graphics/flags.png')
}
...
gFrames = {
    ...
    ['locks-keys'] = GenerateQuads(gTextures['locks-keys'], 16, 16),
    ['poles-flags'] = GenerateQuadsFlags(gTextures['poles-flags'])
}
