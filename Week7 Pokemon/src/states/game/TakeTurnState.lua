                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        function()
                            gStateStack:push(MenuState({
                                ...
                                items = {
                                    {
                                        text = 'HP :: ' .. self.playerPokemon.HP ..  '+' ..  HPIncrease .. '=' .. self.playerPokemon.HP + HPIncrease
                                    },
                                    {
                                        text = 'Attack :: ' .. self.playerPokemon.attack ..  '+' ..  attackIncrease .. '=' .. self.playerPokemon.attack + attackIncrease
                                    },
                                    {
                                        text = 'Defense :: ' .. self.playerPokemon.defense ..  '+' ..  defenseIncrease .. '=' .. self.playerPokemon.defense + defenseIncrease
                                    },
                                    {
                                        text = 'Speed :: ' .. self.playerPokemon.speed ..  '+' ..  speedIncrease .. '=' .. self.playerPokemon.speed + speedIncrease
                                    }
                                },
                                needCursor = false,
                                onPop = self.fadeOutWhite
                            }))
                        end))
                    else
                        self:fadeOutWhite()
