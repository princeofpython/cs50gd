...
function Ball:init(skin)
    ...
    -- if a ball goes out of bounds, it is removed
    self.remove = false 
end
...
function Ball:newReset()
    --function to take care of new balls
    --created by powerups

    self.y = math.random( VIRTUAL_HEIGHT * 0.5, VIRTUAL_HEIGHT * 0.7)
