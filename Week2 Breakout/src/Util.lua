...
--[[
    This function is especially for Powerups from the sprite sheet
]]
...
function GenerateQuadLocked(atlas)
    local x = 160
    local y = 48

    quad = love.graphics.newQuad(x, y, 32, 16, atlas:getDimensions())
